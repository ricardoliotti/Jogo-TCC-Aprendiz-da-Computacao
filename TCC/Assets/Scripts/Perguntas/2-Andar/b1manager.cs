...
public class b1manager : MonoBehaviour
{
    ...
    public void loadData()//Função que pega as informações do banco e printa na tela
    {
        FirebaseDatabase.DefaultInstance.GetReference("redes").ValueChanged += b1manager_ValueChanged;
    }
    private void b1manager_ValueChanged(object sender, ValueChangedEventArgs e)
    {
        respCorreta[0] = e.Snapshot.Child("1").Child("correta").GetValue(true).ToString();
        respCorreta[1] = e.Snapshot.Child("1").Child("pergunta").GetValue(true).ToString();
        respCorreta[2] = e.Snapshot.Child("1").Child("A").GetValue(true).ToString();
        respCorreta[3] = e.Snapshot.Child("1").Child("B").GetValue(true).ToString();
        respCorreta[4] = e.Snapshot.Child("1").Child("C").GetValue(true).ToString();
        respCorreta[5] = e.Snapshot.Child("1").Child("dica").GetValue(true).ToString();
    ...
    //Função que compara se o colisor do personagem está em contato com o colisor do PC para 
    //abrir a tela da pergunta
    ...
    //Função que compara a respostas escolhida com a certa e
    //faz o contator de erros e acertos
    ...
    public void btn_fecharErro()//botão fechar do erro box
    {
